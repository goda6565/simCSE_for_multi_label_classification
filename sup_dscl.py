...
from config.sup_dscl_args import training_args
...
from models.sup_dscl import SimCSEModel

import wandb

wandb.init(project="SimCSE-for-multilabel", name="sup-dscl")
...
# エンコーダを保存
encoder_path = "outputs/sup_dscl/encoder"
