...
from config.sup_pe_args import training_args
...
from collates.sup.sup_pe_train import sup_train_collate_fn
from models.sup_scl import SimCSEModel

import wandb

wandb.init(project="SimCSE-for-multilabel", name="sup-pe")
...
# エンコーダを保存
encoder_path = "outputs/sup_pe/encoder"
