...
from utils.scl_label import create_same_label_datasets
from config.sup_scl_args import training_args
...
from collates.sup.sup_scl_train import sup_train_collate_fn
from models.sup_scl import SimCSEModel

import wandb

wandb.init(project="SimCSE-for-multilabel", name="sup-scl")
...
# SCLように訓練データを再構成(positive_ensured)
scl_train_dataset = create_same_label_datasets(train_dataset)
...
trainer = SimCSETrainer(
    ...
    train_dataset=scl_train_dataset,
