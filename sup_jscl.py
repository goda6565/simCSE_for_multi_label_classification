...
from config.sup_jscl_args import training_args
...
from models.sup_jscl import SimCSEModel

import wandb

wandb.init(project="SimCSE-for-multilabel", name="sup-jscl")
...
# エンコーダを保存
encoder_path = "outputs/sup_jscl/encoder"
